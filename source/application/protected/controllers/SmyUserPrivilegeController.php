...
class SmyUserPrivilegeController extends Controller
{
	/**
	...
	{
		$model=new SmyUserPrivilege;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['SmyUserPrivilege']))
		{
			$model->attributes=$_POST['SmyUserPrivilege'];
	...
	{
		$dataProvider=new CActiveDataProvider('SmyUserPrivilege');
	...
	{
		$model=new SmyUserPrivilege('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['SmyUserPrivilege']))
			$model->attributes=$_GET['SmyUserPrivilege'];
	...
	public function loadModel()
	{
		...
		{
			if(isset($_GET['id']))
				$this->_model=SmyUserPrivilege::model()->findbyPk($_GET['id']);
			if($this->_model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='smy-user-privilege-form')
		{
